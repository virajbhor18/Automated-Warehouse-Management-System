<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/MasterPage.master" AutoEventWireup="true" CodeFile="GenerateBill.aspx.cs" Inherits="Admin_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 ValidationExpression ="[0-9]{10}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group"> 
                       <asp:Button ID="Button1" runat="server" Text="Generate Bill"  ValidationGroup="a" class="btn btn-primary" OnClick="Button1_Click"
                                />
                    </div>
