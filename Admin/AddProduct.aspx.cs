...
public partial class Admin_Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            using (SqlCommand cmd1 = new SqlCommand("select distinct(Period) from slot_master",conn))
            {
                ...
                DropDownList1.Items.Insert(0, new ListItem("SELECT PERIOD"));
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (msg1 == "edit")
        {
            ...
            using (
                SqlCommand cmd =
                    new SqlCommand(
                        "update product_master set name=@name,Company_Name=@cname,date=@date,slot_period=@period,email=@email where id=@id",
                        conn))
            {
            ...
            else
            {
               ...
               //SqlCommand cmd1 =
               //    new SqlCommand(
               //        "insert into temp_store (name,Company_name,email,date,slot_period) values(@name,@cname,@email,@date,@period)",
               //        conn))
               //     {
               //         DateTime date1 = Convert.ToDateTime(txtdoj.Text);
               //         Label1.Visible = false;
               ...
               //         cmd1.Parameters.AddWithValue("@period", DropDownList1.SelectedItem.Text);
               ...
               SqlCommand cmd1 =
                   new SqlCommand(
                       "insert into product_master (name,Company_name,email,date,slot_period) values(@name,@cname,@email,@date,@period)",
                       conn))
                    {
                        DateTime date1 = Convert.ToDateTime(txtdoj.Text);
                        Label1.Visible = false;
